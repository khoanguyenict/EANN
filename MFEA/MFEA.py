...
class MFEA:
    ...
    def evolution(self):
        ...
        print(self.population[1].print_parameters())
    ...
    def sumarizeTrainingStep(self):
        ...
        X_train = self.X_train.T
        Y_train = self.Y_train.T
        ...
        plt.plot(x, self.mse['mse2'], 'b')
        plt.legend(['sgd', 'mfea'], loc='upper right')
        plt.ylabel('loss')
        plt.xlabel('epoch')
        plt.title('compare loss SGD and MFEA')
        plt.show()
